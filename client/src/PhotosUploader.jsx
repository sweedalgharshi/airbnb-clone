...
function PhotosUploader({ addedPhotos, onChange }) {
  ...
  function handleDeleteImage(e, filename) {
    e.preventDefault();
    console.log(filename);
    onChange([...addedPhotos.filter((photo) => photo !== filename)]);
  }

  function handleSelectMainPhoto(e, filename) {
    e.preventDefault();
        ...
        {addedPhotos.length > 0 &&
          addedPhotos.map((link, i) => (
            <div key={i} className="h-32 flex relative">
              ...
              />
              <button
                onClick={(e) => handleDeleteImage(e, link)}
              ...
              <button
                onClick={(e) => handleSelectMainPhoto(e, link)}
