      ...
      {action === "new" && (
        <div>
          <form>
            ...
            <p className="text-gray-500 text-sm">Upload photos of the place</p>
            ...
            <p className="text-gray-500 text-sm">
              add check in and out time, remember to have some time window for cleaning the room
              between guests
            </p>
            <div className="grid gap-2 sm:grid-cols-3">
              ...
              <div>
                ...
                <input type="text" placeholder="3 guests maximum" />
              </div>
            </div>
            <div>
