      ...
      <div className="absolute inset-0 bg-black min-h-screen text-white">
        <div className="bg-black p-8 grid gap-4">
          ...
          {place.photo?.length > 0 &&
            place.photo.map((eachPhoto, i) => {
              return (
                <div key={i}>
                  <img src={`http://localhost:4000/uploads/${eachPhoto}`} alt="" />
                </div>
              );
            })}
        </div>
  ...
  return (
    <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex gap-1 font-semibold block underline my-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      <div className="relative">
        ...
        <button
          onClick={() => setShowAllPhotos(true)}
          className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl border border-black shadow-md shadow-gray-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
